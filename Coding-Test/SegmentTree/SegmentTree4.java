    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (query == 1) {
                ...
                bw.write(tree.prefixMultiple(1, 1, node, left, right) + "\n");
            }
        }
...
class SegmentTree {
     ...
     * size   : 원본 배열의 크기
     * MOD    : 구간곱의 크기가 너무 커지는 것을 방지하기 위한 보정값(== 오버플로우 사전 예방)
     */
    private long[] values;
    private long[] tree;
    private int size;
    ...
    /*
     * 값 수정
     * index 위치의 값을 value로 변경하고 관련된 구간곱 갱신
     */
